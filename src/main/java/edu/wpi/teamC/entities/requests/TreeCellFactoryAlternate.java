...
import edu.wpi.teamC.views.serviceRequest.ITreeMenuControllerAlternate;
...
public class TreeCellFactoryAlternate extends TextFieldTreeCell<NodeDB> {
    ITreeMenuControllerAlternate setCell;
    static HashMap<String,String> categoryToEnglish;

    public TreeCellFactoryAlternate(ITreeMenuControllerAlternate setCell) {
        this.setCell=setCell;
    }
    public TreeCellFactoryAlternate(){
    initHash();
    }
        ...
        if (showMenu(n, bln)) {
            setOnMousePressed(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent event) {
                    setCell.setLocationAlternate(n.getNodeID());
