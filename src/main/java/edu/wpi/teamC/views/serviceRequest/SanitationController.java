...
import edu.wpi.teamC.entities.requests.SanitationRequest;
...
public class SanitationController implements ITreeMenuController{
    @FXML private JFXTextField desc;
    @FXML private Label sanitationRequestText;
    ...
    @FXML private Text requestAreaText;
    ...
    public void translate() throws IOException {
        desc.setPromptText(tr.translate("en", language, desc.getPromptText()));
        sanitationRequestText.setText(tr.translate("en", language, sanitationRequestText.getText()));
    ...
    public void initialize() throws SQLException, IOException {
        ...
        AnchorPane.setTopAnchor(vbox, anchor.getPrefWidth()*240/1280);
        AnchorPane.setBottomAnchor(vbox, anchor.getPrefWidth()*80/1280);
    ...
    private void addSanitationRequest() {
        ...
        SanitationRequest sanr = new SanitationRequest(sr.getRequestID(), currentUser, description, location, assignUserName, isComplete);
        database.addSanitationRequest(sanr);

    }

    private void sendEmail() throws MessagingException {
        SendEmail se = new SendEmail(email,"brighamandwomenshospital1@gmail.com");
        se.setMessageSubject("Sanitation Request");
    ...
    public void goEmergency(ActionEvent actionEvent) {
        try {
            Capp.prevPage = "/edu/wpi/teamC/fxml/serviceRequest/Sanitation.fxml";
    ...
    private void validateButton(){
        if(location.equals("") || employeeChooser.getText().isEmpty()){
